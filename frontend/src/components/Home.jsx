...
const Sidebar = ({ currentView, setCurrentView }) => {
  ...
  return (
    <div className="glass-panel sidebar-container" style={{ padding: '24px', display: 'flex', gap: '32px', overflowX: 'hidden' }}>
      ...
      <motion.button onClick={() => nav('/login')} className="glass-btn custom-cursor-target logout-btn" style={{ marginTop: 'auto', width: '100%' }}><LogOut size={18} /> <span className="nav-text">Logout</span></motion.button>
    </div>
  );
};
